...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean colorSelector
        {
            get
            {
                return SteamVR_Actions.default_colorSelector;
            }
        }
        
        public virtual SteamVR_Action_Boolean textureSelector
        {
            get
            {
                return SteamVR_Actions.default_textureSelector;
            }
        }
