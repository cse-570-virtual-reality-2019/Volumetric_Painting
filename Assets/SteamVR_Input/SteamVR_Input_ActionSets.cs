...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_painting p_painting;
        ...
        public static SteamVR_Input_ActionSet_painting painting
        {
            get
            {
                return SteamVR_Actions.p_painting.GetCopy<SteamVR_Input_ActionSet_painting>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_painting = ((SteamVR_Input_ActionSet_painting)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_painting>("/actions/painting")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.painting};
        }
    }
}
